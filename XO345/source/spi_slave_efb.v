...
/* Module Version: 1.2 */
/* E:\lscc\diamond\3.4_x64\ispfpga\bin\nt64\scuba.exe -w -n spi_slave_efb -lang verilog -synth synplify -bus_exp 7 -bb -type efb -arch xo3c00a -freq 50 -spi -spi_mode Slave -spi_rxr -spi_en -wb -dev 6900  */
/* Sun Aug 16 21:04:35 2015 */


`timescale 1 ns / 1 ps
module spi_slave_efb (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, 
    wb_adr_i, wb_dat_i, wb_dat_o, wb_ack_o, spi_clk, spi_miso, spi_mosi, 
    spi_scsn, spi_irq)/* synthesis NGD_DRC_MASK=1 */;
    input wire wb_clk_i;
    input wire wb_rst_i;
    input wire wb_cyc_i;
    input wire wb_stb_i;
