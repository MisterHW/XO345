...
-- Module  Version: 6.4
--E:\lscc\diamond\3.4_x64\ispfpga\bin\nt64\scuba.exe -w -n ram_dp -lang vhdl -synth lse -bus_exp 7 -bb -arch xo3c00a -type bram -wp 10 -rp 0011 -rdata_width 8 -data_width 8 -num_rows 64 -cascade -1 -mem_init1 
...
architecture Structure of ram_dp is
    ...
    attribute MEM_INIT_FILE of ram_dp_0_0_0 : label is "INIT_ALL_1s";
...
begin
    ...
    ram_dp_0_0_0: DP8KC
        ...
        port map (DIA8=>scuba_vlo, DIA7=>Data(7), DIA6=>Data(6), 
            ...
            ADB10=>scuba_vlo, ADB9=>scuba_vlo, ADB8=>RdAddress(5), 
